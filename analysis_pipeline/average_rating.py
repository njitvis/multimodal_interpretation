...
df["mean_rating"] = (df["interpretability_rating_phd_res1"] + df["interpretability_rating_phd_res2"] + df["interpretability_rating_u_res1"] + df["interpretability_rating_u_res2"]) / 4
