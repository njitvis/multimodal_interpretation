...
clarity = pd.read_csv("./data/reasons_chart_segment_grp.csv")
usefulness = pd.read_csv("./data/reasons_caption_segment_grp.csv")

clarity = clarity[(clarity["group"] == "_u_res1") | (clarity["group"] == "_u_res2")]
usefulness = usefulness[(usefulness["group"] == "_u_res1") | (usefulness["group"] == "_u_res2")]
...
plt.tight_layout()
plt.savefig("./output/clarity_usefulness_rating_phd.png", dpi=300)
plt.close()

clarity = pd.read_csv("./data/reasons_chart_segment_grp.csv")
usefulness = pd.read_csv("./data/reasons_caption_segment_grp.csv")

clarity = clarity[(clarity["group"] == "_res1") | (clarity["group"] == "_res2")]
usefulness = usefulness[(usefulness["group"] == "_res1") | (usefulness["group"] == "_res2")]
