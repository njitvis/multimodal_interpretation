...
const L1l4Distribution = () => {
	...
	return (
		<Analysis
			goal="Distribution of L1-L4 sentences"
			obs={[
				{
					"For captions with low interpretability (1-3):": [
						"high proportion of L1 and L4 sentences is observed for low proportion of L3 sentences",
						"higher the porportion of L1 sentences, lower the proportion of L4 sentences and vice versa",
						"about 1/3 captions have high L1 and L4 sentences",
						"almost half the captions have high proportion of L4 sentences"
					]
				},
				{
					"For captions with high interpretability (4-5):": [
						"high proportion of L1 sentences is observed but is less than L4 sentences",
						"lower the porportion of L3 sentences, higher the proportion of L1 and L4 sentences and vice versa"
					]
				},
			]}
			next={[
				"Impact of occurrance of L1 and L4 sentences must on interpretability rating must be analyzed.",
				"Weighted occurrence must be considered because proportion of L1 and L4 sentences are inversely proportional in low interpretability ratings.",
				"L1 and L4 sentences appear most frequently and L2 sentences appear least frequently."
			]}
		>
...
export default L1l4Distribution;
